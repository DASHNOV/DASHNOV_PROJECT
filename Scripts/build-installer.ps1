...
@("server.js", "package.json", "package-lock.json", ".env.example", ".env", "SQL.env") | ForEach-Object {
...
$installScript = "C:\DASHNOV\Installer\Install.ps1"
...
$fixScript = "C:\DASHNOV\Installer\fix-client-installation.ps1"
...
$updateScript = "C:\DASHNOV\Installer\update-interface-client.ps1"
...
3. Test manuel : cd C:\DashNov\Server && node server.js
...
$readmeSource = "C:\DASHNOV\Installer\README_PREREQUISITES.md"
