async function creerUtilisateur() {
    ...
    try {
        const response = await fetch('http://192.168.201.36:8085/creerUtilisateur', {
            method: 'POST',
            headers: {
...
async function chargerUtilisateurs() {
    try {
        const response = await fetch('http://192.168.201.36:8085/users', {
            method: 'GET',
...
async function chargerUtilisateurPourModification(utilisateurId) {
    try {
        const response = await fetch(`http://192.168.201.36:8085/users/${utilisateurId}`, {
            method: 'GET',
            headers: { 'Authorization': `Bearer ${sessionStorage.getItem('accessToken')}` }
        });
...
async function chargerProfilsDansSelect(selectedProfileId = null, selectId) {
    try {
        const response = await fetch('http://192.168.201.36:8085/profiles', {
            method: 'GET',
            headers: { 'Authorization': `Bearer ${sessionStorage.getItem('accessToken')}` }
        });
...
async function modifierUtilisateur() {
    ...
    try {
        const response = await fetch(`http://192.168.201.36:8085/updateUser/${utilisateurId}`, {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${sessionStorage.getItem('accessToken')}`,
                'Content-Type': 'application/json'
...
async function supprimerUtilisateur(utilisateurID) {
    ...
    try {
        const response = await fetch(`http://192.168.201.36:8085/deleteUser/${utilisateurID}`, {
            method: 'DELETE',
            headers: { 'Authorization': `Bearer ${sessionStorage.getItem('accessToken')}` }
        });
...
async function supprimerProfil(profilID) {
    ...
    try {
        const response = await fetch(`http://192.168.201.36:8085/deleteProfile/${profilID}`, {
            method: 'DELETE',
            headers: { 'Authorization': `Bearer ${sessionStorage.getItem('accessToken')}` }
        });
...
async function modifierProfil() {
    try {
        ...
        const response = await fetch(`http://192.168.201.36:8085/profiles/${profilId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
